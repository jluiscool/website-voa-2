...
function ContactUsSection() {
    return (
        <div className='w-[100%] p-[1.5rem] bg-white flex flex-col  text-black tablet:p-[2rem] tablet:flex-row tablet:gap-y-[2rem] tablet:justify-between'>
            <div className='items-center justify-start flex flex-col tablet:w-[45%] tablet:justify-center mb-[2rem]'>
