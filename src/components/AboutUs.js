...
function AboutUs() {
    return (
        <div className='bg-white flex flex-col px-[1.5rem]'>
            <h2 className='text-hot-pink text-[2rem] font-bold text-center my-[1rem]'>About Us</h2>
            ...
            <p className='mb-[1rem]'>We offer full dubbing services in Miami from script adaptation, to casting, sound design and mixing. VOA MIAMI is the best place to localize your content wherever you need.</p>
            <iframe className="mb-[1.5rem]" src="https://www.youtube.com/embed/WagefXarPhE" title="YouTube video player" allowFullScreen></iframe>
        </div>
    )
}
