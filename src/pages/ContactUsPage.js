...
function ContactUsPage() {
    return (
        <main className='bg-cover bg-no-repeat'>
            ...
            <div className="text-white bg-black px-[1.5rem] flex flex-col gap-y-[0.5rem] pt-[1rem]">
                <h3>
            ...
            <div className="bg-black px-[1.5rem] py-[1.5rem]">
                <ContactForm />
            </div>
            <div className="bg-black px-[1.5rem] flex flex-col gap-y-[1rem] pb-[1.5rem]">
                <div>
