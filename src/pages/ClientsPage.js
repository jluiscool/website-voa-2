...
function ClientsPage() {
    return (
        <main>
            ...
            <section className='flex flex-col justify-start items-start p-[1.5rem] bg-black gap-y-[1rem] tablet:p-[2rem] tablet:flex-row tablet:flex-wrap tablet:gap-x-[2rem] tablet:justify-between'>
                {
